...
/* Name: Steven Song
   ...
   CS2150 Lab 3 Post Lab ListNode.h 
*/

// NOTE: ListNode.h was copied over here from the Lab 2 Post Lab with one important new modification at the bottom of this file 
...
private:
    ...
    friend class Stack; // You need to include this for the PostLab in Lab 3
}; // We have to include friend class Stack in ListNode.h 
