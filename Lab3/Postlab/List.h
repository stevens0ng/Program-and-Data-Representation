...
/* Name: Steven Song 
   ...
   CS2150 Lab 3 Post Lab List.h
*/

// NOTE: I added the friend class for Stack to the List header file (newly added for Lab 3's Post Lab) 

// This file was downloaded from the source code for List.h that was given to us in the PDR (didn't modify this file)
...
#include "ListNode.h" // All the header files that we have to include in the List class 
#include "ListItr.h"
...
private: // You want 2 dummy nodes: one for the head and one for the tai
  ...
  // NEWLY ADDED for Lab 3 Post Lab  
  friend class Stack; // You need this for the PostLab in Lab 3
};

// IMPORTANT: head is the first ListNode in the list
// tail is the last ListNode in the list
// count is just the number of ListNodes in the list 
