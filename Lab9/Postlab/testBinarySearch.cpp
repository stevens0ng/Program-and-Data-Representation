/*Name: Steven Song  
  UVA ID: sqs5hrn 
  Date: April 21, 2021  
  CS2150 Lab 9 Post Lab testBinarySearch.cpp   
*/

// NOTE: The testBinarySearch.cpp file was downloaded from the PDR/source code for the Lab 9 Post Lab (didn't modify this file)
